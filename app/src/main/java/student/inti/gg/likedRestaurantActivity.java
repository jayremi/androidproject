...
public class likedRestaurantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liked_restaurant);


        mRecyclerView=findViewById(R.id.recyclerlikedRestaurant);
        ...
        if(user!=null)
        {
            ...
            mDatabase = FirebaseDatabase.getInstance().getReference("Users").child(uid).child("Liked").child("Liked Restaurant");
            showRecycler1();
        }
