...
public class likedItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liked_item);


        mRecyclerView=findViewById(R.id.recyclerlikeditem);
        ...
        if(user!=null)
        {
            ...
            mDatabase = FirebaseDatabase.getInstance().getReference("Users").child(uid).child("Liked").child("Liked item");
            showRecycler1();
        }
